...
namespace quanlymypham.Forms
{
    public partial class formSanPham : Form
    {
        ...
        private void datagridViewSP_Click(object sender, EventArgs e)
        {
            ...
            cbomaloai.Text = Functions.GetFieldValues("SELECT TenLoai FROM Loai WHERE TenLoai= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenKhoiLuong"].Value.ToString();
            cbomakhoiluong.Text = Functions.GetFieldValues("SELECT TenKhoiLuong FROM KhoiLuong WHERE TenKhoiLuong= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenHangSX"].Value.ToString();
            cbomahangSX.Text = Functions.GetFieldValues("SELECT TenHangSX FROM HangSanXuat WHERE TenHangSX= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenChatLieu"].Value.ToString();
            cbomachatlieu.Text = Functions.GetFieldValues("SELECT TenChatLieu FROM ChatLieu WHERE TenChatLieu= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenCongDung"].Value.ToString();
            cbomacongdung.Text = Functions.GetFieldValues("SELECT TenCongDung FROM CongDung WHERE TenCongDung= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenMua"].Value.ToString();
            cbomamua.Text = Functions.GetFieldValues("SELECT TenMua FROM Mua WHERE TenMua= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenMau"].Value.ToString();
            cbomamausac.Text = Functions.GetFieldValues("SELECT TenMau FROM MauSac WHERE TenMau= N'" + ten + "'").ToString();

            ten = datagridViewSP.CurrentRow.Cells["TenNuocSX"].Value.ToString();
            cbomanuocSX.Text = Functions.GetFieldValues("SELECT TenNuocSX FROM NuocSanXuat WHERE TenNuocSX= N'" + ten + "'").ToString();
            ...
            txtghichu.Text = Functions.GetFieldValues("SELECT Ghichu FROM HangHoa WHERE MaHang = N'" + txtmasanpham.Text + "'").ToString();
            txtanh.Text = Functions.GetFieldValues("SELECT Anh FROM HangHoa WHERE MaHang = N'" + txtmasanpham.Text + "'").ToString();
